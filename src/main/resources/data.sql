...
('플리지뱅크 신용대출', 'LOAN', 5.1, 60, 1000000.00, 30000000.00, '신용 기반 저금리 대출 상품입니다.', '["빠른 심사", "낮은 금리", "유연한 상환"]', true, 'ACTIVE', NOW(), NOW()),
('플리지 자유입출금', 'CHECKING', 1.2, NULL, 0, NULL, '언제든지 자유롭게 입금하고 출금할 수 있는 입출금 계좌입니다.', '["입출금 자유", "연 1.2% 금리", "수수료 면제", "모바일뱅킹 연동"]', true, 'ACTIVE', NOW(), NOW()); 